...
class An_Eccube_PageContextTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testConstructor()
    {
        ...
        $context = new An_Eccube_PageContext($init, $this->secret_key);
        $this->assertEquals($init, $context->getArrayCopy());

        $secret_key = str_rot13($this->secret_key);
        $context = new An_Eccube_PageContext($init, $secret_key);
    ...
    {
        $context = new An_Eccube_PageContext(array(), $this->secret_key);

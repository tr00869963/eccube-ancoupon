...
class plugin_info
{
    ...
    public static $PLUGIN_CODE = 'AnCoupon';
    ...
    /** 作者(必須)：プラグイン作者. */
    public static $AUTHOR = 'M-soft';

    /** 説明(必須)：プラグインの説明. */
    public static $DESCRIPTION = 'クーポンによる割引購入機能を追加します。また、紹介クーポンサービス「アドパワー」などの連携システムにもなります。';

    /** プラグイン作者URL：プラグイン毎に設定出来るURL（説明ページなど） */
    public static $AUTHOR_SITE_URL = 'http://ad-power.jp/top/';

    /** クラス名(必須)：プラグインのクラス（拡張子は含まない） */
    public static $CLASS_NAME = 'AnCoupon';

    /** フックポイント：フックポイントとコールバック関数を定義します */
    public static $HOOK_POINTS = array();

    /** プラグインURL：プラグイン毎に設定出来るURL（説明ページなど） */
    public static $PLUGIN_SITE_URL = 'http://ad-power.jp/top/';

...
<script type="text/javascript">//<![CDATA[
    ...
    function func_submit(product_id, class_name1, class_name2) {
        ...
        var opner_product_id = 'product_new';
        var opner_product_class_id = 'product_class_new';
        var class_required = parseInt('<!--{$class_required}-->');
        ...
        fm.mode.value = 'refresh';
        fm.anchor_key.value = 'target';
        fm.submit();
        window.close();
...
<input name="class_required" type="hidden" value="<!--{$class_required|h}-->" />
<table class="form">
    <col width="20%" />
    <col width="80%" />
    <tr>
